    ...
    >
      <div className="flex items-center justify-between navbar">
        ...
        <div className="flex-none">
          {/* Mens fashion */}
          <div className="hidden dropdown-hover dropdown dropdown-bottom dropdown-end lg:block md:block">
            <label tabIndex={0} className="m-1">
              <span className="cursor-pointer">Mens Fashion</span>
            </label>
            <ul
              style={{
                borderRadius: "5px",
          ...
          <div className="hidden mx-6 dropdown-hover dropdown dropdown-bottom dropdown-end lg:block md:block">
            <label tabIndex={0} className="m-1">
              <span className="cursor-pointer">Womens Fashion</span>
            </label>
            <ul
              style={{
                borderRadius: "5px",
          ...
          {/* Kids */}
          <div className="hidden mr-6 dropdown-hover dropdown dropdown-bottom dropdown-end lg:block md:block">
            <label tabIndex={0} className="m-1">
          ...
          <div className="hidden form-control lg:block md:block">
            <input
              style={{
                borderRadius: "5px",
                backgroundImage: "linear-gradient(45deg, #884A39, #FCE9F1)",
