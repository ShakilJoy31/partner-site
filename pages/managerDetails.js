  ...
  return (
    <div className="mb-8">
      ...
      <div className={`${HomeComponentCss.ownerDetails} my-[44px]`}>
        <p className={`flex justify-center pt-[10px] ${HomeComponentCss.OwnerHeading}`}>Owner Details</p>
      </div>
      ...
      <div>
        <div>
          <div className="flex items-center justify-between">
            ...
            <div className=" form-control">
              <label className="label">
                <span className={`${HomeComponentCss.inputHead}`}>Full Name *</span>
          ...
          <div className=" form-control w-[360px]">
              <label className="label">
                <span className={`${HomeComponentCss.inputHead}`}>Profile pic</span>
                <span className="label-text-alt"><BsFillInfoCircleFill size={15} color={'#DC3545'}></BsFillInfoCircleFill></span>
              </label>
          ...
          <div className="flex items-center mt-[129px]">
            ...
            <button className={`${HomeComponentCss.yesNoButton} mx-[20px]`}>Yes</button>
